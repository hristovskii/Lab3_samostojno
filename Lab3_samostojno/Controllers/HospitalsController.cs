...
using Lab3_samostojno.Models;

namespace Lab3_samostojno.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,URL,Address")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,URL,Address")] Hospital hospital)
        {
            if (ModelState.IsValid)
            {
